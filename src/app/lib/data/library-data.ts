    ...
    sections: [
      {
        ...
        items: [{
          ...
          scripture: ["ఆదికాండము 1:1 — \"ఆదియందు దేవుడు భూమ్యాకాశములను సృజించెను.\"", "కొలొస్సయులకు 1:16 — \"ఏలయనగా ఆకాశమందున్నవియు భూమియందున్నవియు, దృశ్యమైనవిగాని అదృశ్యమైనవిగాని... సర్వమును ఆయన ద్వారాను ఆయనను బట్టియు సృజింపబడెను.\""]
        }]
      },
      {
        id: "nc-2",
        ...
        items: [{
          ...
          scripture: ["యోహాను 1:1 — \"ఆదియందు వాక్యము ఉండెను, వాక్యము దేవుని యొద్ద ఉండెను, వాక్యము దేవుడై ఉండెను.\"", "హెబ్రీయులకు 1:3 — \"ఆయన దేవుని మహిమయొక్క ప్రకాశమును, ఆయన తత్వముయొక్క మూర్తిమంతమునై యుండి, తన బలముగల మాటచేత సమస్తమును నిర్వహించుచు...\""]
        }]
      },
      {
        id: "nc-3",
        ...
        items: [{
          ...
          scripture: ["మత్తయి 1:23 — \"ఇదిగో కన్యక గర్భవతియై కుమారుని కనును, ఆయనకు ఇమ్మానుయేలను పేరు పెట్టుదురు...\"", "1 కొరింథీయులకు 15:3-4 — \"లేఖనముల ప్రకారము క్రీస్తు మన పాపముల నిమిత్తము మృతిపొందెననియు...\"", "లూకా 1:33 — \"ఆయన యాకోబు వంశస్తులను యుగయుగములు ఏలును; ఆయన రాజ్యమునకు అంతముండదు.\""]
        }]
      },
      {
        id: "nc-4",
        ...
        items: [{
          ...
          scripture: ["యోహాను 15:26 — \"తండ్రి యొద్ద నుండి నేను మీ యొద్దకు పంపబోవు ఆదరణకర్త...\"", "ఎఫెసీయులకు 4:4-5 — \"శరీరమొక్కటే, ఆత్మయు ఒక్కడే...\"", "ప్రకటన 21:4 — \"ఆయన వారి కన్నుల ప్రతి భాష్పబిందువును తుడిచివేయును...\""]
        }]
      }
    ]
  },
